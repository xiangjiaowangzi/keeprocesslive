...
package com.example.keepprocesslive.account;
...
public class SyncAccountUtils {
    ...
    private static final String CONTENT_AUTHORITY = "com.keep.process.account.provider";
    ...
    public static void triggerRefresh(Context context) {
        ...
        ContentResolver.requestSync(
                GenericAccountService.GetAccount(context, ACCOUNT_TYPE), // Sync account
                KeepLiveAccountProvider.AUTHORITY,                 // Content authority
                b);                                             // Extras
    }
}
